...
/**
 * This code for B+ tree was taken from online from the following git of Fang Jiaguo
...
public class BPlusTree<K extends Comparable<? super K>, V> {
	...
	public static void main(String[] args) {
		BPlusTree<Integer,String> test = new BPlusTree<Integer,String>();
		
		test.insert(10, "file1");
//		test.insert(3, "file2");
		test.insert(45, "file3");
		test.insert(11, "file4");
		test.insert(4, "file5");
		test.insert(47, "file6");
		String ans = test.search(3);
//		System.out.println(ans);
		List<String> ans1 = test.searchRange(-3, RangePolicy.INCLUSIVE, 45, RangePolicy.INCLUSIVE);
		for(String e : ans1) {
